...
public class TesterSwitch {
	...
	public static void main(String[] args) {
		...
		switch(opc) { 
		case 'A': resultado = vlr1 + vlr2; break; //adição
		case 'B': resultado = vlr1 - vlr2; break; //subtração
		case 'C': resultado = vlr1 * vlr2; break; //multiplicação
		case 'D': resultado = vlr1 / vlr2; break; //divisão
		case 'E': resultado = vlr1 % vlr2; break; //resto
		case 'F': resultado = 0; break; //fim
		default: 
